...
Khiem Do
Project 4
Creating and manipulating the AVL tree. Tough tho!
*/
#include "AVLTree.h"
#include <iostream>
#include <string>
...
int main() {
    ...
    // This should return false (no duplicates allowed):
    ...
    */
    ...
    cout << tree.find(75, result) << endl;//true
    cout << result << endl; //One hundred seventy-five

    cout << tree.find(600, result) << endl << endl; //false
